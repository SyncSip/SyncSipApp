...
export class MachinesController {
    ...
    @ApiResponse({ status: 400, description: 'Bad request' })
    @ApiResponse({ status: 500, description: 'Internal Server Error' })
    async create(@Body() createMachineDto: CreateMachineDto): Promise<ReadMachineDto>{
    ...
    @ApiResponse({ status: 400, description: 'Bad request' })
    @ApiResponse({ status: 500, description: 'Internal Server Error' })
    async edit(@Param("id") id:string, @Body() editMachineDto: EditMachineDto): Promise<ReadMachineDto>{
        console.log(id)
