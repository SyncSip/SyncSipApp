...
export class GrindersController {
    ...
    @ApiResponse({ status: 400, description: 'Bad request' })
    @ApiResponse({ status: 500, description: 'Internal Server Error' })
    async create(@Body() createGrinderDto: CreateGrinderDto): Promise<ReadGrinderDto>{
    ...
    @ApiResponse({ status: 400, description: 'Bad request' })
    @ApiResponse({ status: 500, description: 'Internal Server Error' })
    async edit(@Param("id") id:string, @Body() editGrinderDto: EditGrinderDto): Promise<ReadGrinderDto>{
        console.log(id)
