...
export class Migrations1744112935905 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "beans" ADD "altitudeInMeters" character varying`,
    );
    await queryRunner.query(`ALTER TABLE "beans" ADD "roastDate" TIMESTAMP`);
    await queryRunner.query(
      `ALTER TABLE "beans" ADD "process" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "beans" ADD "genetic" character varying`,
    );
    await queryRunner.query(
      `ALTER TABLE "beans" ADD "variety" character varying`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "beans" DROP COLUMN "altitudeInMeters"`,
    );
  }
}
