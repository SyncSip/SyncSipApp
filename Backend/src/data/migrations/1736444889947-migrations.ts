...
export class Migrations1736444889947 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "shots" ALTER COLUMN "machineId" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "shots" ALTER COLUMN "grinderId" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "shots" ALTER COLUMN "beansId" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "shots" ALTER COLUMN "group" DROP NOT NULL`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "shots" ALTER COLUMN "group" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "shots" ALTER COLUMN "beansId" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "shots" ALTER COLUMN "grinderId" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "shots" ALTER COLUMN "machineId" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "shots" ADD CONSTRAINT "FK_5d065879cacf185333d14b18881" FOREIGN KEY ("beansId") REFERENCES "beans"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
